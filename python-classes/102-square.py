...
class Square:
    ...
    def __lt__(self, other):
        """
        Check if the area of this square is less than another.
    ...
    def __le__(self, other):
        """
        Check if the area of this square is less than or equal to another.

        Args:
            other (Square): The square to compare with.

        Returns:
            bool: True if this square's area
    ...
    def __gt__(self, other):
        """
        Check if the area of this square is greater than another.
    ...
    def __ge__(self, other):
        """
        Check if the area of this square is greater than or equal to another.

        Args:
            other (Square): The square to compare with.

        Returns:
            bool: True if this square's area is greater than
